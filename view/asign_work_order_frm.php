...
$servidor_route = $_SERVER['DOCUMENT_ROOT']."/logistic_corp";
    ...
    <input type="hidden" name="indicador" >
        ...
        <div class="col-md-2">
              <br>
              <a href="./asign_work_order.php"><div class="btn btn-sm btn btn-secondary form-control">Cancelar</div></a>
        </div>
        <div class="col-md-2">
              <br>
              <div class="btn btn-sm btn-primary form-control" onclick="asignar_order_lin()">Guardar</div>
        </div>
    </form>    
