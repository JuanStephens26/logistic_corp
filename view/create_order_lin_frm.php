...
$servidor_route = $_SERVER['DOCUMENT_ROOT']."/logistic_corp";
    ...
    <input type="hidden" name="indicador" >
        ...
        <div class="col-md-2">
              <br>
              <a href="./create_order_frm.php?no_order=<?php echo $id ?>&indicador=CU"><div class="btn btn-sm btn btn-secondary form-control">Cancelar</div></a>
        </div>
        <?php 
        ...
        <div class="col-md-2">
              <br>
              <div class="btn btn-sm btn-danger form-control" onclick="eliminar_order_lin()">Eliminar</div>
        </div>
        <?php
        }
        ?>
        <div class="col-md-2">
              <br>
              <div class="btn btn-sm btn-primary form-control" onclick="guardar_order_lin()">Guardar</div>
        </div>
        <?php
        }
        ?>
