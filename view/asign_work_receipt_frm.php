...
$servidor_route = $_SERVER['DOCUMENT_ROOT']."/logistic_corp";
    ...
    <input type="hidden" name="indicador" >
        ...
        <div class="input-group input-group-sm mb-3">
            ...
            <select class="form-select" name="no_locc" required>
            <option value=""></option>
        ...
        <div class="input-group input-group-sm mb-3">
            ...
            <select class="form-select" name="user_work" required>
            <option value=""></option>
        ...
        <div class="col-md-2">
              <br>
              <a href="./asign_work_receipt.php"><div class="btn btn-sm btn btn-secondary form-control">Cancelar</div></a>
        </div>
        <div class="col-md-2">
              <br>
              <div class="btn btn-sm btn-primary form-control" onclick="asignar_receipt_lin()">Guardar</div>
        </div>
    </form>    
