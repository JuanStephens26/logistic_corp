...
$servidor_route = $_SERVER['DOCUMENT_ROOT']."/logistic_corp";
   ...
   $reportes = $obj_reportes->consultar_import();
   ...
   $nfilas=count($reportes);
    ...
    print ("<caption>Importaciones</caption>\n");
    print ("<thead class='table-dark'>\n");
    print ("<TR>\n");
    print ("<TH scope='col'>No. Entrada</th>\n");
    print ("<TH scope='col'>No. Linea</th>\n");
    print ("<TH scope='col'>Cliente</th>\n");
    print ("<TH scope='col'>Cantidad</th>\n");
    print ("<TH scope='col'>Cantidad Entro</th>\n");
    print ("<TH scope='col'>Productos</th>\n");
    print ("</TR>\n");
    print ("</thead>\n");
    if ($nfilas > 0){
    foreach ($reportes as $resultado){
        print ("<tbody>\n");
        ?>
        <TR style='cursor:pointer;' id="<?php echo $resultado['no_receipt']?>">
        <?php
        ...
        print ("<TD>".$resultado['qty_located']."</td>\n");
        print ("<TD>".$resultado['prtnum']."</td>\n");
        print ("</TR>\n");
        print ("</tbody>\n");
    }
  }
