...
<nav class="navbar navbar-expand-lg">
  <div class="collapse navbar-collapse" id="navbarNav">
   <div id="navbarNav1"> 
    <ul class="navbar-nav all_width">
      <li class="nav-item" style="border-right: 1px solid;">
        <a class="nav-link" href="./home.php">Administrador</a>
      </li>
      <li class="nav-item" style="border-right: 1px solid;">
        <a class="nav-link" href="./import.php">Importación</a>
      </li>
      <li class="nav-item" style="border-right: 1px solid;">
        <a class="nav-link" href="./export.php">Exportación</a>
      </li>
      <li class="nav-item">
